...
description: "Configure a branded subdomain for Marketing Cloud Next-hosted landing pages using the Salesforce CDN option."
---

## Overview

Marketing Cloud Next landing pages default to a Salesforce CDN URL. Replacing it with a branded subdomain (e.g., `pages.leoptical.com`) makes your landing page URLs look like they belong to LEOptical rather than Salesforce.
...
The DNS records use your org's 15-digit org ID as part of the CNAME target. Marketing Cloud Next provides the exact values in the setup UI when you configure the domain.
...
5. Marketing Cloud Next displays two CNAME records using your org's ID. Copy them.
...
- [ ] A landing page domain is configured in Domain Settings using the CDN option.
